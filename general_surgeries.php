      ...
      <div class="inner_banner" style="background-image: url(assets/images/specialities_banner.png);">
         <div class="container-fluid text-center">
            <div class="inner_bantext">
               <h2>General Surgeries</h2>
            </div>
            <div class="breadcrumb-menu">
               <ul>
                  <li><a href="index-2.html">Home</a></li>
                  <li><a href="javascript:;">Specialities</a></li>
                  <li class="active">General Surgeries</li>
               </ul>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/general_surgeries.png">
                        </div>
                        <div class="blog_details">
                           <h4>General Surgeries</h4>
                           <p>At Jawahar Hospital, our General Surgeons are dedicated to providing expert surgical care for 
                            a wide range of conditions, from minor procedures to complex surgeries. With state-of-the-art 
                            technology and a patient-centric approach, we ensure the best possible outcomes for your health
                             and well-being.</p>
                           <ul>
                              <li><strong>Experienced General Surgeons:</strong> Our team of skilled surgeons has vast 
                              experience in performing a variety of general surgeries with precision and care.</li>
                              <li><strong>Comprehensive Surgical Care:</strong> We offer a broad range of surgical services, 
                              including abdominal surgery, hernia repair, gallbladder removal, appendectomy, and more.</li>
                              <li><strong>Minimally Invasive Techniques: </strong>Whenever possible, we use minimally invasive 
                              methods like laparoscopy, which results in smaller incisions, less pain, 
                              and faster recovery times.</li>
                              <li><strong>Advanced Surgical Technology:</strong>Equipped with modern surgical tools and 
                              techniques, we ensure high standards of safety and effectiveness.</li>
                              <li><strong>Post-Operative Care:</strong>Our team provides comprehensive follow-up care, 
                              ensuring a smooth recovery and helping to manage any post-surgical concerns.</li>
                           </ul>
                           <p>At Jawahar Hospital, we prioritize your health and safety, offering expert general 
                            surgical care with compassion and commitment to excellent outcomes.</p>
