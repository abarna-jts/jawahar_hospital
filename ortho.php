            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/ortho_specialist.png">
                        </div>
                        <div class="blog_details">
                           <h4>Ortho Specialist</h4>
                           <p>At Jawahar Hospital, our Orthopedic Specialists provide expert care for a wide range of musculoskeletal conditions,
                             from fractures and joint pain to spinal issues and sports injuries. With advanced diagnostic tools and personalized 
                             treatment plans, we are dedicated to restoring mobility and improving quality of life for our patients.</p>
                           <ul>
                              <li><strong>Expert Orthopedic Surgeons: </strong>Highly trained specialists with vast experience in
                               treating bone, joint, and muscle conditions.</li>
                              <li><strong>Comprehensive Care:  </strong>Diagnosis and treatment of a variety of orthopedic issues, 
                              including fractures, arthritis, sports injuries, and spinal disorders.</li>
                              <li><strong>Advanced Treatment Options:</strong>From non-surgical treatments like physical therapy 
                              and medications to advanced surgical procedures such as joint replacement and minimally invasive
                               spine surgery.</li>
                              <li><strong>Cutting-Edge Technology:  </strong> Equipped with state-of-the-art diagnostic tools 
                              and surgical technology to ensure precise treatment.</li>
                               <li><strong>Post-Operative Care and Rehabilitation: </strong>Comprehensive rehabilitation 
                               programs to promote faster recovery and restore full function after surgery or injury.</li>
                           </ul>
                           <p>At Jawahar Hospital, we are committed to providing compassionate and expert orthopedic care, 
                            helping you regain mobility and live pain-free.</p>
