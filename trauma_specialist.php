            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/trauma_speciality.png">
                        </div>
                        <div class="blog_details">
                           <h4>Trauma</h4>
                           <p>At Jawahar Hospital, our Trauma Care Unit is designed to provide immediate, life-saving care 
                            to patients in critical conditions resulting from accidents, injuries, or other emergencies.
                             With a multidisciplinary team of experts and state-of-the-art facilities, we ensure rapid
                              diagnosis, treatment, and recovery for trauma patients.</p>
                           <ul>
                              <li><strong>24/7 Emergency Response:</strong>Our trauma care unit operates 
                              round the clock to handle all types of emergencies, ensuring timely and effective care.</li>
                              <li><strong>Highly Skilled Team: </strong>Led by experienced trauma surgeons, orthopaedic 
                              specialists, neurologists, and critical care experts who work together to stabilize and treat patients.</li>
                              <li><strong>Advanced Diagnostics: </strong>Equipped with high-speed imaging, 
                              CT scans, X-rays, and laboratory facilities for quick and accurate evaluation.</li>
                              <li><strong>Comprehensive Care:</strong>Specialized services for head injuries, fractures,
                               polytrauma, chest injuries, and internal bleeding, ensuring holistic patient management.</li>
                              <li><strong>Well-Equipped ICU:</strong>Our intensive care units are equipped with 
                              advanced monitoring systems and life-support facilities for critical patients.</li>
                           </ul>
                           <p>At Jawahar Hospital, we are committed to saving lives and minimizing complications 
                            with prompt, expert, and compassionate trauma care during the most critical moments.</p>
