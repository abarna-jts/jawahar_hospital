      ...
      <div class="inner_banner" style="background-image: url(assets/images/specialities_banner.png);">
         <div class="container-fluid text-center">
            <div class="inner_bantext">
               <h2>Oral &amp; Maxillo Facial Surgeries</h2>
            </div>
            <div class="breadcrumb-menu">
               <ul>
                  <li><a href="index-2.html">Home</a></li>
                  <li><a href="javascript:;">Specialities</a></li>
                  <li class="active">Oral &amp; Maxillo Facial Surgeries</li>
               </ul>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/oral.png">
                        </div>
                        <div class="blog_details">
                           <h4>Oral &amp; Maxillo Facial Surgeries</h4>
                           <p>At Jawahar Hospital, our Oral & Maxillofacial Surgery Department specializes in the diagnosis
                             and treatment of complex conditions affecting the mouth, jaws, face, and neck. With advanced
                              surgical techniques and cutting-edge technology, our skilled surgeons provide personalized care
                               to restore function, aesthetics, and overall oral health.</p>
                           <ul>
                              <li><strong>Expert Surgeons:</strong>Our experienced maxillofacial surgeons are trained to handle a 
                              wide range of conditions, including facial trauma, jaw deformities, and oral tumors.</li>
                              <li><strong>Comprehensive Surgical Care:</strong>From corrective jaw surgery and wisdom tooth
                               removal to treating oral cancer and facial reconstruction, we offer a full spectrum of services.</li>
                              <li><strong>Advanced Diagnostic Tools:</strong>Equipped with 3D imaging and 
                              modern diagnostic tools for precise treatment planning and execution.</li>
                              <li><strong>Minimally Invasive Procedures:</strong>Utilizing advanced techniques to 
                              minimize scarring, pain, and recovery time for better patient outcomes.</li>
                              <li><strong>Multidisciplinary Approach:</strong>Collaborating with dentists, orthodontists, and ENT 
                              specialists to provide holistic care for complex conditions.</li>
                           </ul>
                           <p>At Jawahar Hospital, our Oral & Maxillofacial Surgery team is committed to delivering expert
                             care with precision, compassion, and attention to detail, ensuring the best possible
