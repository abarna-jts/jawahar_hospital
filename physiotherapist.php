         ...
         <div class="container-fluid text-center">
            ...
            <div class="breadcrumb-menu">
               <ul>
                  ...
                  <li class="active">Physiotherapist</li>
               </ul>
            </div>
         </div>
      </div>
               ...
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blog_details">
                           ...
                           <p> At Jawahar Hospital, our expert Physiotherapists are dedicated to helping patients regain strength, 
                            mobility, and independence through personalized treatment plans. Whether recovering from an injury, 
                            surgery, or managing a chronic condition, our physiotherapy team provides compassionate and effective 
                            care to enhance your quality of life.</p>
                           <ul>
                              <li><strong>Expert Physiotherapists:</strong>Our team of skilled physiotherapists specializes 
                              in musculoskeletal, neurological, and post-surgical rehabilitation to meet diverse patient needs.</li>
                              <li><strong>Comprehensive Rehabilitation Programs: </strong>We offer tailored therapies for 
                              sports injuries, joint replacements, stroke recovery, back pain, and more.</li>
                              <li><strong>Advanced Treatment Techniques:</strong>Incorporating the latest physiotherapy methods, 
                              including manual therapy, electrotherapy, ultrasound, and exercise programs.</li>
                              <li><strong>Pain Management & Mobility Improvement: </strong>RFocused on relieving pain,
                               improving movement, and restoring functionality to help patients resume daily activities.</li>
                              <li><strong>Holistic Approach: </strong>Emphasizing overall wellness with lifestyle 
                              advice, posture correction, and preventive care strategies.</li>
                           </ul>
                           <p>At Jawahar Hospital, our physiotherapy team works closely with you to create an 
                            individualized recovery plan, ensuring a quicker return to health and improved 
                            well-being.</p>
