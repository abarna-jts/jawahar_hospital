         ...
         <div class="container-fluid text-center">
            ...
            <div class="breadcrumb-menu">
               <ul>
                  ...
                  <li class="active">Child Specialist</li>
               </ul>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/child_specialist.png">
                        </div>
                        <div class="blog_details">
                           <h4>Child Specialist</h4>
                           <p>At Jawahar Hospital, our expert Child Specialists (Pediatricians) are dedicated to 
                            providing comprehensive care for children from infancy through adolescence. With a focus 
                            on preventive care, early diagnosis, and treatment of childhood illnesses, we ensure the
                            health and well-being of your child in a compassionate and child-friendly environment.</p>
                           <ul>
                              <li><strong>Experienced Pediatricians:</strong>Our team consists of highly trained 
                              specialists with extensive experience in treating children’s health concerns.</li>
                              <li><strong>Comprehensive Pediatric Care:</strong>We provide a full range of 
                              services, including routine check-ups, vaccinations, and management of acute 
                              and chronic childhood illnesses.</li>
                              <li><strong>Child-Centered Approach: </strong>Our clinic is designed to make
                               your child feel at ease, with a friendly and supportive environment 
                               tailored to their needs.</li>
                              <li><strong>Advanced Diagnostic Tools: </strong>We use state-of-the-art diagnostic
                               equipment to ensure accurate assessments and timely interventions for your child's health.</li>
                              <li><strong>Emergency Pediatric Care: </strong>We offer 24/7 emergency services for any 
                              urgent medical needs, ensuring that your child receives immediate attention when needed.</li>
                           </ul>
                           <p>At Jawahar Hospital, we are committed to your child's health and development,
                            providing expert care at every stage of their growth.</p>
