               ...
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blog_details">
                           <h4>Echo/ECG</h4>
                           <p>At Jawahar Hospital, we offer cutting-edge Echo and ECG facilities to ensure accurate heart
                             assessments and timely diagnosis of cardiac conditions.</p>
                           <ul>
                              <li><strong>Echocardiogram (Echo):</strong>A non-invasive test that provides real-time 
                              images to assess heart structure, function, and blood flow, ensuring accurate cardiac diagnosis.</li>
                              <li><strong>Electrocardiogram (ECG):</strong> A quick and painless test to monitor the heart's 
                              electrical activity, detecting arrhythmias and other cardiac abnormalities.</li>
                              <li><strong>State-of-the-Art Technology:</strong>Equipped with the latest tools and expert
                               technicians to deliver precise results for early diagnosis and effective treatment.</li>
                           </ul>
                           <p>With our Echo and ECG services, we aim to provide superior cardiac care, ensuring
                             the best outcomes for your heart health.</p>
