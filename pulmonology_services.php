      ...
      <div class="inner_banner" style="background-image: url(assets/images/specialities_banner.png);">
         <div class="container-fluid text-center">
            <div class="inner_bantext">
               <h2>Pulmonology Services</h2>
            </div>
            <div class="breadcrumb-menu">
               <ul>
                  <li><a href="index.php">Home</a></li>
                  <li><a href="javascript:;">Specialities</a></li>
                  <li class="active">Pulmonology Services</li>
               </ul>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/pulmonology_services.png">
                        </div>
                        <div class="blog_details">
                           <h4>Pulmonology Services</h4>
                           <p>At Jawahar Hospital, our Pulmonology Department is dedicated to providing expert care for respiratory health.
                             From treating common breathing disorders to managing complex lung diseases, our team of skilled 
                             pulmonologists offers advanced diagnostic and therapeutic solutions to help patients breathe 
                             easier and live healthier lives.</p>
                           <ul>
                              <li><strong>Expert Pulmonologists:</strong>Our highly trained specialists diagnose and treat a 
                              wide range of respiratory conditions, including asthma, chronic obstructive pulmonary
                               disease (COPD), pneumonia, and lung cancer.</li>
                              <li><strong>Comprehensive Respiratory Care: </strong>Offering advanced care for sleep apnea, 
                              interstitial lung diseases, pulmonary hypertension, and other complex respiratory issues.</li>
                              <li><strong>State-of-the-Art Diagnostics:  </strong>Equipped with advanced tools such as pulmonary
                               function tests (PFT), bronchoscopy, chest imaging, and sleep studies for accurate diagnosis.</li>
                              <li><strong>Emergency Respiratory Care:</strong>Providing 24/7 care for critical respiratory conditions, including 
                              acute asthma attacks, respiratory distress, and other life-threatening emergencies.</li>
                              <li><strong>Personalized Treatment Plans:</strong>Tailored therapies that include medication management, pulmonary
                               rehabilitation, and lifestyle guidance for long-term respiratory health.</li>
                           </ul>
                           <p>At Jawahar Hospital, our Pulmonology Department is committed to helping patients achieve
                             better lung health with compassionate care, cutting-edge technology, and a focus on 
                             improving overall quality of life.</p>
