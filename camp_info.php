...
<main class="main_wrapper">
    <section class="section_banner">
        <div class="inner_banner" style="background-image: url(assets/images/camp_banner.png);">
            <div class="container-fluid text-center">
                <div class="inner_bantext">
                    <h2>Our Camp Details</h2>
                </div>
                <div class="breadcrumb-menu">
                    <ul>
                        <li><a href="index.php">Home</a></li>
                        <li><a href="javascript:;">Patient Guide</a></li>
                        <li class="active">Our Camp Details</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="service-content">
                        <section class="health_update">
                            <div class="container">
                                ...
                                <div class="owl-carousel owl-theme health_update_slider owl-loaded owl-drag">
                                    <div class="owl-stage-outer">
                                        <div class="owl-stage" style="transform: translate3d(-1160px, 0px, 0px); transition: 0.25s; width: 2321px;">
                                            <div class="owl-item" style="width: 386.667px;">
                                                <h2 class="text-center h3-tit mb-md-3">DIABETES CARDIO METABOLIC CAMP</h2>
                                                <div class="item hp_wrapper">

                                                    <a href="common-womens-health-issues.php">
                                                        <div class="blg_img">
                                                            <img src="assets/images/camp_1.png">
                                                        </div>
                                                        <div class="blog_details">
                                                            <h4>THE COMPLETE DIABETES CARE</h4>
                                                            <p>1. Blood Complete | 2. Lipid Profile | 3. Blood Sugar Fasting & Pp | 4. Tsh Uric Acid | 5. Ecg | Uroflowmetry And All Other Tests
                                                                1. Retinopathy Eye Screening | 2. Biothesimetry | 3. Bmd Scans | 4. Podiatric Clinic | 5. Dietician For Diet | 6. Cgm/Abpm/Holter</p>
                                                            <h5>The purpose of Jawahar Hospital is to provide excellent healthcare</h5>
                                                            <p>For all at affordable costs with latest technology & expertise. All other advanced diabetic studies under a single roof.</p>
                                                            
                                                                <span><img src="assets/images/calender-orange.svg">27TH JULY 2024</span>
                                                        </div>
                                                        <div class="square_box bg-orange"></div>
                                                    </a>
                                                </div>
                                            </div>
                                            <div class="owl-item" style="width: 386.667px;">
                                                <h2 class="text-center h3-tit mb-md-3">DIABETES CARDIO METABOLIC CAMP - 2</h2>
                                                <div class="item hp_wrapper">

                                                    <a href="common-womens-health-issues.php">
                                                        <div class="blg_img">
                                                            <img src="assets/images/camp_2.png">
                                                        </div>
                                                        <div class="blog_details">
                                                            <h4>THE COMPLETE DIABETES CARE</h4>
                                                            <p>1. Blood Complete | 2. Lipid Profile | 3. Blood Sugar Fasting & Pp | 4. Tsh Uric Acid | 5. Ecg | Uroflowmetry And All Other Tests
                                                                1. Retinopathy Eye Screening | 2. Biothesimetry | 3. Bmd Scans | 4. Podiatric Clinic | 5. Dietician For Diet | 6. Cgm/Abpm/Holter</p>
                                                            <h5>The purpose of Jawahar Hospital is to provide excellent healthcare</h5>
                                                            <p><strong>Rs.5000/- worth Test Free.</strong> For all at affordable costs with latest technology & expertise. All other advanced diabetic studies under a single roof.</p>
                                                            
                                                                <span><img src="assets/images/calender-orange.svg">12TH JULY 2024</span>
                                                        </div>
                                                        <div class="square_box bg-orange"></div>
                                                    </a>
                                                </div>
                                            ...
                                            <div class="owl-item" style="width: 386.667px;">
                                                <h2 class="text-center h3-tit mb-md-3">DIABETES CARDIO METABOLIC CAMP - 3</h2>
                                                <div class="item hp_wrapper">

                                                    <a href="common-womens-health-issues.php">
                                                        <div class="blg_img">
                                                            <img src="assets/images/camp_3.png">
                                                        </div>
                                                        <div class="blog_details">
                                                            <h4>THE COMPLETE DIABETES CARE</h4>
                                                            <p>1. Blood Complete | 2. Lipid Profile | 3. Blood Sugar Fasting & Pp | 4. Tsh Uric Acid | 5. Ecg | Uroflowmetry And All Other Tests
                                                            ...
                                                            <p><strong>Rs.5000/- worth Test Free.</strong> For all at affordable costs with latest technology & expertise. All other advanced diabetic studies under a single roof.</p>
                                                                ...
                                                                <span><img src="assets/images/calender-orange.svg">29TH JULY 2024</span>
                                                        </div>
                                                        <div class="square_box bg-orange"></div>
                                                    </a>
                                                </div>
