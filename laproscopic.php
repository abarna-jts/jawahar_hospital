      ...
      <div class="inner_banner" style="background-image: url(assets/images/services_banner.png);">
         <div class="container-fluid text-center">
            <div class="inner_bantext">
               <h2>Laproscopic-key Hole Surgeries</h2>
            </div>
            <div class="breadcrumb-menu">
               <ul>
                  <li><a href="index-2.html">Home</a></li>
                  <li><a href="javascript:;">Services</a></li>
                  <li class="active">Laproscopic-key Hole Surgeries</li>
               </ul>
            </div>
         </div>
      </div>
               ...
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blog_details">
                           <h4>Laproscopic-key Hole Surgeries</h4>
                           <p>At Jawahar Hospital, we specialize in advanced Laparoscopic (Keyhole) Surgeries, a minimally invasive
                             technique that ensures faster recovery, reduced pain, and smaller scars. Our expert surgical team is 
                             equipped with state-of-the-art technology to perform a wide range of procedures with precision and care.</p>
                           <ul>
                              <li><strong>Minimally Invasive Technique: </strong>Smaller incisions result in less pain, minimal scarring, and faster recovery.</li>
                              <li><strong>Advanced Technology:  </strong>Equipped with cutting-edge laparoscopic instruments for precision and safety.</li>
                              <li><strong>Expert Surgical Team:  </strong>  Highly skilled surgeons ensure optimal outcomes for every procedure.</li>
                              <li><strong>Wide Range of Procedures:  </strong>Includes surgeries for gallbladder, appendix, hernia, gynecological issues, and more.</li>
                              <li><strong>Shorter Hospital Stays:  </strong>Most patients can return home sooner with improved post-operative comfort.</li>
                           </ul>
                           <p>At Jawahar Hospital, we are committed to providing advanced surgical care 
                            to help you heal faster and return to your daily life with ease.</p>
