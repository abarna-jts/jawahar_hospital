      ...
      <div class="inner_banner" style="background-image: url(assets/images/services_banner.png);">
         <div class="container-fluid text-center">
            <div class="inner_bantext">
               <h2>Head Injury Care/Poly Trauma</h2>
            </div>
            <div class="breadcrumb-menu">
               <ul>
                  <li><a href="index.php">Home</a></li>
                  <li><a href="javascript:;">Services</a></li>
                  <li class="active">Head Injury Care/Poly Trauma</li>
               </ul>
            </div>
         </div>
      </div>
               ...
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blog_details">
                           <h4>Head Injury Care/Poly Trauma</h4>
                           <p>At Jawahar Hospital, we provide specialized care for Head Injuries and Poly Trauma, offering 
                            immediate, expert medical attention to patients dealing with life-threatening conditions. Our 
                            multidisciplinary team is equipped with advanced technology and facilities to manage complex 
                            injuries effectively and ensure the best possible outcomes.</p>
                           <ul>
                              <li><strong>24/7 Emergency Services: </strong>Round-the-clock care for critical injuries, ensuring timely intervention.</li>
                              <li><strong>Specialized Trauma Team: </strong>Expert neurosurgeons, orthopedic surgeons, and 
                              critical care specialists work together for comprehensive treatment.</li>
                              <li><strong>Advanced Diagnostic Tools:  </strong>Equipped with CT scans, MRIs, and trauma-focused imaging for precise diagnosis.</li>
                              <li><strong>Intensive Care Facilities: </strong>State-of-the-art ICUs for continuous monitoring and post-trauma management.</li>
                              <li><strong>Rehabilitation Support: </strong>Dedicated physiotherapy and rehabilitation services for faster recovery.</li>
                           </ul>
                           <p>At Jawahar Hospital, we are committed to saving lives and supporting patients on their road to recovery with expert
                             care for head injuries and poly trauma cases.</p>
