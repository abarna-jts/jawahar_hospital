      ...
      <div class="inner_banner" style="background-image: url(assets/images/services_banner.png);">
         <div class="container-fluid text-center">
            <div class="inner_bantext">
               <h2>Arthroscopy Surgeries</h2>
            </div>
            <div class="breadcrumb-menu">
               <ul>
                  <li><a href="index-2.html">Home</a></li>
                  <li><a href="javascript:;">Services</a></li>
                  <li class="active">Arthroscopy Surgeries</li>
               </ul>
            </div>
         </div>
      </div>
               ...
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blog_details">
                           <h4>Arthroscopy Surgeries</h4>
                           <p>At Jawahar Hospital, we offer advanced Arthroscopy Surgeries, a minimally invasive procedure designed 
                            to diagnose and treat joint problems with precision. Using state-of-the-art arthroscopic equipment,
                             our skilled surgeons ensure effective treatment with minimal discomfort and faster recovery for our patients.</p>
                           <ul>
                              <li><strong>Minimally Invasive Technique: </strong>Equipped with state-of-the-art technology to 
                              support a wide range of complex surgeries.</li>
                              <li><strong>Expert Orthopedic Surgeons:  </strong>Highly skilled surgeons and support staff
                               ensure precision and safety during every procedure.</li>
                              <li><strong>Advanced Technology: </strong> Equipped with high-definition arthroscopic cameras for accurate visualization and treatment.</li>
                              <li><strong>Wide Range of Procedures:  </strong>Includes treatments for knee, shoulder, hip, ankle, and other joint conditions.</li>
                              <li><strong>Faster Rehabilitation:  </strong>Enables quicker return to normal activities compared to traditional surgical methods.</li>
                           </ul>
                           <p>At Jawahar Hospital, our goal is to restore your mobility and improve your quality of life with the latest advancements in arthroscopic care.</p>
