         ...
         <div class="container-fluid text-center">
            ...
            <div class="breadcrumb-menu">
               <ul>
                  ...
                  <li class="active">Obstetrics &amp; Gynaecology</li>
               </ul>
            </div>
         </div>
      </div>
               ...
               <div class="sidebar">
                  <div class="widget widget-categories">
                     ...
                     <ul>
                        ...
                        <li><a href="trauma.php">Trauma <img src="assets/images/circle-next-arrow.svg"></a></li>
            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/ob_ge.png">
                        </div>
                        <div class="blog_details">
                           <h4>Obstetrics &amp; Gynaecology</h4>
                           <p>At Jawahar Hospital, our Obstetrics and Gynaecology Department is dedicated to the complete 
                            healthcare needs of women across all stages of life. From routine check-ups and prenatal care 
                            to advanced treatments for gynaecological conditions, our expert team provides compassionate 
                            and personalized care to ensure the health and well-being of every woman.</p>
                           <ul>
                              <li><strong>Experienced Specialists:  </strong>Our highly qualified obstetricians and 
                              gynaecologists are experienced in managing routine and complex cases with the utmost expertise.</li>
                              <li><strong>Comprehensive Women’s Care:</strong>We provide a wide range of services, including 
                              antenatal care, high-risk pregnancy management, infertility treatments, and menstrual
                               disorder management.</li>
                              <li><strong>Advanced Diagnostic & Treatment Options:</strong>Equipped with cutting-edge 
                              technology for ultrasounds, minimally invasive procedures, and advanced gynaecological surgeries.</li>
                              <li><strong>High-Risk Pregnancy Care:</strong>Specialized care for high-risk pregnancies with 
                              access to modern facilities and a multidisciplinary team for the best outcomes.</li>
                              <li><strong>Preventive Healthcare:</strong>Focused on regular screenings, including Pap 
                              smears, mammograms, and pelvic exams, to ensure early detection and prevention of
                               potential health issues.</li>
                           </ul>
                           <p>At Jawahar Hospital, we are committed to providing exceptional care for women 
                            at every stage of life, offering expertise, comfort, and support when it matters most.</p>
