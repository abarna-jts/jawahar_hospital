         ...
         <div class="container-fluid text-center">
            ...
            <div class="breadcrumb-menu">
               <ul>
                  ...
                  <li class="active">Digital X-Ray</li>
               </ul>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/x-ray.png">
                        </div>
                        <div class="blog_details">
                           <h4>Digital X-Ray</h4>
                           <p>At Jawahar Hospital, we provide advanced digital X-ray facilities that ensure accurate and fast
                               imaging results for effective diagnosis and treatment. Our cutting-edge equipment offers several
                                advantages over traditional X-rays:</p>
                           <ul>
                              <li><strong>High Image Quality:</strong>Digital X-rays produce clearer, high-resolution images,
                               allowing doctors to detect even the smallest abnormalities.</li>
                              <li><strong>Reduced Radiation Exposure:</strong>Our technology minimizes radiation exposure,
                                making it safer for patients, including children and seniors.</li>
                              <li><strong>Quick Results:</strong> Images are instantly available, speeding up the
                               diagnostic process and ensuring timely treatment.</li>
                              <li><strong>Enhanced Comfort:</strong>The process is more comfortable and efficient, reducing wait times and improving the overall patient experience.</li>
                           </ul>
                           <p>Whether it’s for injury assessment, routine screenings, or specialized 
                              imaging, our digital X-ray facilities ensure accurate results under the care of skilled radiologists.</p>
