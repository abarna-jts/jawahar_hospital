         ...
         <div class="container-fluid text-center">
            ...
            <div class="breadcrumb-menu">
               <ul>
                  ...
                  <li class="active">Diabetologist</li>
               </ul>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/diabetelogist.png">
                        </div>
                        <div class="blog_details">
                           <h4>Diabetologist</h4>
                           <p>At Jawahar Hospital, our expert Diabetologists provide comprehensive care for the prevention, diagnosis, 
                            and management of diabetes. Whether you’re managing Type 1 or Type 2 diabetes, or dealing with related 
                            complications, we offer personalized treatment plans to help you lead a healthy, active life.</p>
                           <ul>
                              <li><strong>Experienced Diabetologists:</strong>Our team of skilled specialists has extensive 
                              experience in managing diabetes and its associated conditions.</li>
                              <li><strong>Comprehensive Diabetes Management: </strong>From blood sugar 
                              monitoring to medication management and lifestyle modifications, we provide complete care for diabetes.</li>
                              <li><strong>Advanced Diagnostic Tools: </strong>We use cutting-edge 
                              technology to accurately diagnose and track diabetes and related complications.</li>
                              <li><strong>Personalized Treatment Plans:</strong>Tailored care plans that 
                              focus on managing your diabetes and improving your overall health.</li>
                              <li><strong>Patient Education:</strong>We provide education on diet, 
                              exercise, and self-monitoring to empower patients to take 
                              control of their condition.</li>
                           </ul>
                           <p>At Jawahar Hospital, we are committed to helping you manage diabetes effectively, ensuring a healthier and more fulfilling life.</p>
