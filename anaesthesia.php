         ...
         <div class="container-fluid text-center">
            ...
            <div class="breadcrumb-menu">
               <ul>
                  ...
                  <li class="active">Anaesthesia</li>
               </ul>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/anesthesia.png">
                        </div>
                        <div class="blog_details">
                           <h4>Anaesthesia</h4>
                           <p> At Jawahar Hospital, we provide Comprehensive Anaesthesia Services to ensure comfort and safety for 
                            patients undergoing surgeries and medical procedures. Our experienced anaesthesiologists utilize the latest 
                            techniques and equipment to manage pain, monitor vital signs, and ensure a smooth and pain-free experience 
                            throughout your treatment.</p>
                           <ul>
                              <li><strong>Experienced Anaesthesiologists:  </strong>Our team of skilled specialists ensures
                               the highest level of care during any procedure.</li>
                              <li><strong>Personalized Care Plans: </strong>We tailor anaesthesia techniques to the specific 
                              needs of each patient, considering age, health conditions, and procedure requirements.</li>
                              <li><strong>Advanced Monitoring:</strong>State-of-the-art monitoring systems track vital 
                              signs and ensure safety throughout the procedure.</li>
                              <li><strong>Pain Management Expertise:  </strong> Focused on providing effective pain
                               relief, both during and after surgery, to enhance recovery.</li>
                              <li><strong>Comprehensive Pre-Operative Assessment: </strong>Detailed evaluations to
                               plan the safest anaesthesia approach for each patient.</li>
                           </ul>
                           <p>At Jawahar Hospital, our anaesthesia team is committed to delivering exceptional care, 
                            ensuring your comfort and safety throughout your medical treatment or surgery.</p>
