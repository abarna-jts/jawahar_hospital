      ...
      <div class="inner_banner" style="background-image: url(assets/images/services_banner.png);">
         <div class="container-fluid text-center">
            <div class="inner_bantext">
               <h2>Twin Operation Theatre</h2>
            </div>
            <div class="breadcrumb-menu">
               <ul>
                  <li><a href="index-2.html">Home</a></li>
                  <li><a href="javascript:;">Services</a></li>
                  <li class="active">Twin Operation Theatre</li>
               </ul>
            </div>
         </div>
      </div>
               ...
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blog_details">
                           <h4>Twin Operation Theatre</h4>
                           <p> Our Twin Operation Theatre is designed with advanced technology and infrastructure to perform 
                            simultaneous surgeries, ensuring seamless and timely treatment for our patients.</p>
                           <ul>
                              <li><strong>Advanced Surgical Facilities: </strong>Equipped with state-of-the-art technology to 
                              support a wide range of complex surgeries.</li>
                              <li><strong>Dedicated Surgical Teams:  </strong>Highly skilled surgeons and support staff
                               ensure precision and safety during every procedure.</li>
                              <li><strong>Simultaneous Operations: </strong> Designed to perform two surgeries at the 
                              same time, ensuring efficiency and reduced waiting times.</li>
                              <li><strong>Infection-Control Measures:  </strong>Maintains the highest standards of hygiene
                               and sterilization for patient safety.</li>
                              <li><strong>Real-Time Monitoring Systems: </strong>Equipped with advanced anesthesia 
                              and patient monitoring systems to ensure optimal safety and care during surgeries.</li>
                           </ul>
                           <p>At Jawahar Hospital, our mission is to deliver precision-driven and efficient surgical
                             care in a safe and advanced environment. With our Twin Operation Theatre, we strive to 
                             provide exceptional outcomes, ensuring the highest standards of expertise and care for
                              every patient.</p>
