         ...
         <div class="container-fluid text-center">
            ...
            <div class="breadcrumb-menu">
               <ul>
                  ...
                  <li class="active">Pulmonologist</li>
               </ul>
            </div>
         </div>
      </div>
               ...
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blog_details">
                           <h4>Pulmonologist</h4>
                           <p>At Jawahar Hospital, our expert Pulmonologists specialize in diagnosing and treating a wide range of respiratory 
                            conditions. With advanced diagnostic tools and personalized treatment plans, we are committed to helping patients 
                            breathe easier and improve their lung health.</p>
                           <ul>
                              <li><strong>Expert Pulmonologists: </strong>Highly skilled specialists with extensive experience in managing complex respiratory disorders.</li>
                              <li><strong>Comprehensive Diagnosis:  </strong>Advanced lung function tests, imaging, and bronchoscopy for accurate assessments.</li>
                              <li><strong>Personalized Treatment Plans:  </strong>Tailored care for conditions such as asthma, COPD, bronchitis, pneumonia, and sleep apnea.</li>
                              <li><strong>State-of-the-Art Facilities: </strong>Equipped with cutting-edge technology for precise and effective treatment.</li>
                              <li><strong>Preventive Care: </strong>Focus on patient education, smoking cessation programs, and early intervention for better long-term health.</li>
                           </ul>
                           <p>At Jawahar Hospital, we strive to provide world-class pulmonology care, ensuring better respiratory health and improved quality of life for our patients.</p>
