            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/doppler_studies.png">
                        </div>
                        <div class="blog_details">
                           <h4>Doppler Studies</h4>
                           <p>At Jawahar Hospital, we offer advanced Doppler studies to evaluate blood flow and detect vascular
                             conditions with precision. Our modern technology provides numerous benefits for accurate diagnosis:</p>
                           <ul>
                              <li><strong>Detailed Blood Flow Analysis:</strong>Doppler studies measure the speed and direction of 
                              blood flow in arteries and veins, helping detect blockages, clots, or abnormal circulation.</li>
                              <li><strong>Non-Invasive and Safe:</strong>This radiation-free imaging technique uses sound waves, 
                              ensuring a painless and safe procedure for all patients.</li>
                              <li><strong>Real-Time Results: </strong> Quick and efficient imaging delivers real-time insights,
                               enabling timely diagnosis and treatment planning.</li>
                              <li><strong>Comprehensive Vascular Assessment: </strong>Ideal for detecting conditions like 
                              deep vein thrombosis, varicose veins, and peripheral artery diseases.</li>
                           </ul>
                           <p>Our skilled technicians and advanced Doppler technology ensure reliable results to 
                            support effective diagnosis and care for vascular health.</p>
