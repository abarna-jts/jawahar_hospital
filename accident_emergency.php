            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/accident_emergency.png">
                        </div>
                        <div class="blog_details">
                           <h4>Accident / Emergency Care</h4>
                           <p>Our dedicated Accident and Emergency Department is fully equipped to handle a wide range of medical 
                            emergencies 24/7, ensuring timely and efficient care when every second counts.</p>
                           <ul>
                              <li><strong>24/7 Emergency Services: </strong>Our emergency unit is open round the clock to handle
                               critical situations with speed and efficiency.</li>
                              <li><strong>Expert Team: </strong>Skilled doctors, nurses, and paramedics provide immediate 
                              and compassionate care during emergencies.</li>
                              <li><strong>Advanced Facilities:</strong> Equipped with modern diagnostic tools and life-saving 
                              equipment to address all types of medical emergencies.</li>
                              <li><strong>Specialized Care: </strong>Comprehensive treatment for trauma, cardiac 
                              emergencies, strokes, fractures, and more.</li>
                              <li><strong>Highly Skilled Team:</strong>Our team of experienced emergency doctors, nurses, 
                              and paramedics are trained to handle critical situations with precision and compassion.</li>
                           </ul>
                           <p>At Jawahar Hospital, our mission is to provide timely, compassionate, and lifesaving 
                            care during critical moments. We aim to be your trusted partner in health, offering the 
                            highest level of medical expertise to safeguard you and your loved ones.</p>
