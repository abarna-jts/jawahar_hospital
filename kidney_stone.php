      ...
      <div class="inner_banner" style="background-image: url(assets/images/services_banner.png);">
         <div class="container-fluid text-center">
            <div class="inner_bantext">
               <h2>Laser Kidney Stone Center</h2>
            </div>
            <div class="breadcrumb-menu">
               <ul>
                  <li><a href="index.php">Home</a></li>
                  <li><a href="javascript:;">Services</a></li>
                  <li class="active">Laser Kidney Stone Center</li>
               </ul>
            </div>
         </div>
      </div>
               ...
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blog_details">
                           <h4>Laser Kidney Stone Center</h4>
                           <p>At Jawahar Hospital, our Laser Kidney Stone Center provides advanced, minimally invasive treatments
                             for kidney stones. Using cutting-edge laser technology, we ensure precise, effective, and pain-free
                             stone removal, helping patients recover faster and return to their daily lives with ease.</p>
                           <ul>
                              <li><strong>Advanced Laser Technology: </strong>Breaks down kidney stones with precision, minimizing discomfort and complications.</li>
                              <li><strong>Minimally Invasive Procedure:   </strong> No major incisions, ensuring faster recovery and shorter hospital stays.</li>
                              <li><strong>Experienced Specialists: </strong> Skilled urologists with extensive expertise in laser stone treatment.</li>
                              <li><strong>Comprehensive Care:   </strong>From diagnosis to treatment and follow-up, we provide end-to-end kidney stone care.</li>
                              <li><strong>Effective for All Stone Sizes: </strong>Suitable for treating stones of varying sizes and complexities.</li>
                           </ul>
                           <p>At Jawahar Hospital, we are committed to offering the most advanced and patient-friendly solutions for kidney 
                            stone management, ensuring optimal results and improved quality of life.</p>
