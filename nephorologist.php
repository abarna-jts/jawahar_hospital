            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/nephrologist.png">
                        </div>
                        <div class="blog_details">
                           <h4>Nephrologist</h4>
                           <p>At Jawahar Hospital, our expert Nephrologists provide comprehensive care for the prevention, 
                            diagnosis, and management of kidney-related conditions. Whether you’re dealing with chronic 
                            kidney disease, kidney stones, or any other renal issue, our skilled specialists use advanced 
                            diagnostic tools and treatments to ensure your kidneys remain healthy and function properly.</p>
                           <ul>
                              <li><strong>Experienced Nephrologists:</strong>Our team of highly trained nephrologists specializes
                               in the diagnosis and management of kidney diseases, offering expert care tailored to each patient.</li>
                              <li><strong>Comprehensive Kidney Care:</strong>We provide a wide range of services, including early 
                              detection, dialysis, kidney stone management, kidney transplantation, and treatment for conditions
                               such as hypertension and diabetes.</li>
                              <li><strong>State-of-the-Art Diagnostic Tools:</strong>Equipped with advanced technology, including
                               imaging tests, kidney function assessments, and biopsy procedures for accurate diagnosis and treatment.</li>
                              <li><strong>Personalized Treatment Plans:</strong>We develop individualized care plans that 
                              focus on managing kidney diseases effectively and preventing further complications.</li>
                              <li><strong>Renal Replacement Therapy: </strong>We offer hemodialysis, peritoneal dialysis,
                               and kidney transplant services to patients in need of renal replacement therapy.</li>
                           </ul>
                           <p>At Jawahar Hospital, we are committed to ensuring your child’s health and well-being with the highest level of pediatric expertise and personalized care.</p>
