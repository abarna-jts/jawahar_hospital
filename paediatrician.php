         ...
         <div class="container-fluid text-center">
            ...
            <div class="breadcrumb-menu">
               <ul>
                  ...
                  <li class="active">Paediatrician</li>
               </ul>
            </div>
         </div>
      </div>
               ...
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blog_details">
                           <h4>Paediatrician</h4>
                           <p> At Jawahar Hospital, we are dedicated to providing exceptional medical care for children of all ages, 
                            from newborns to adolescents. Our expert Paediatricians ensure comprehensive healthcare in a child-friendly 
                            environment, addressing both preventive and curative needs with compassion and precision.</p>
                           <ul>
                              <li><strong>Expert Paediatricians:  </strong>Highly skilled doctors with vast experience in diagnosing and treating childhood illnesses..</li>
                              <li><strong>Child-Friendly Approach:  </strong>A warm, caring environment that helps children feel comfortable during treatment.</li>
                              <li><strong>Comprehensive Care: </strong>From routine check-ups and immunizations to managing chronic conditions, we cover all aspects of child health.</li>
                              <li><strong>Emergency Paediatric Services:  </strong>Round-the-clock care for urgent health concerns and emergencies.</li>
                              <li><strong>Specialized Treatments: </strong>Expertise in treating neonatal conditions,
                               developmental issues, respiratory problems, infections, and more.</li>
                           </ul>
