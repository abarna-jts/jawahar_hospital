      ...
      <div class="inner_banner" style="background-image: url(assets/images/facilities_banner.png);">
         <div class="container-fluid text-center">
            <div class="inner_bantext">
               <h2>Computerised Lab</h2>
            </div>
            <div class="breadcrumb-menu">
               <ul>
                  <li><a href="index.php">Home</a></li>
                  <li><a href="javascript:;">Facilities</a></li>
                  <li class="active">Computerised Lab</li>
               </ul>
            </div>
         </div>
      </div>
               ...
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blog_details">
                           <h4>Computerised Lab</h4>
                           <p>At Jawahar Hospital, our fully equipped computerised laboratory combines advanced technology with 
                            precision to deliver reliable and accurate diagnostic services.</p>
                           <ul>
                              <li><strong>Cutting-Edge Technology:</strong> Equipped with the latest automated systems, our 
                              lab ensures high-quality results for every test.</li>
                              <li><strong>Wide Range of Diagnostics:</strong> From routine blood tests to specialized diagnostics, we cover all major lab investigations.</li>
                              ...
                              <li><strong>24/7 Support:</strong> Our laboratory operates round-the-clock to cater to emergency needs and routine testing.</li>
                           </ul>
                           <p>With our advanced computerised lab facilities, we strive to provide patients with accurate, efficient, 
                            and timely diagnostic solutions for better health outcomes.</p>
