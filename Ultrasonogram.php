         ...
         <div class="container-fluid text-center">
            ...
            <div class="breadcrumb-menu">
               <ul>
                  ...
                  <li class="active">Ultrasonogram</li>
               </ul>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/ultrasonogram.png">
                        </div>
                        <div class="blog_details">
                           <h4>Ultrasonogram</h4>
                           <p>At Jawahar Hospital, we provide advanced Ultrasonogram services to deliver precise and real-time
                             imaging for accurate diagnosis and treatment.</p>
                           <ul>
                              <li><strong>High-Resolution Imaging:</strong>Our ultrasonogram equipment produces detailed and 
                              clear images of internal organs, tissues, and blood flow, aiding in accurate medical assessment.</li>
                              <li><strong>Safe and Radiation-Free:</strong>Using sound waves instead of radiation, our ultrasonogram 
                              is completely safe, making it ideal for all patients, including pregnant women and children.</li>
                              <li><strong>Quick and Efficient Results:</strong>The procedure is fast and painless, providing
                               real-time results to ensure prompt diagnosis and treatment planning.</li>
                              <li><strong>Comfortable Patient Experience:</strong>With modern, patient-friendly facilities,
                               we ensure a smooth and stress-free experience during the imaging process.</li>
                           </ul>
                           <p>Whether it’s for routine screenings, pregnancy monitoring, or specialized diagnostic needs, 
                            our Ultrasonogram services deliver reliable results under the care of our experienced professionals.</p>
