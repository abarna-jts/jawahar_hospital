         ...
         <div class="container-fluid text-center">
            ...
            <div class="breadcrumb-menu">
               <ul>
                  ...
                  <li class="active">Joint Replacement</li>
               </ul>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/joint.png">
                        </div>
                        <div class="blog_details">
                           <h4>Joint Replacement</h4>
                           <p>At Jawahar Hospital, we specialize in Joint Replacement Surgeries to help patients regain mobility 
                            and live a pain-free life. Whether due to arthritis, injury, or other degenerative conditions, 
                            our skilled orthopedic team uses advanced techniques and high-quality prosthetics to replace 
                            damaged joints, improving quality of life and restoring function.</p>
                           <ul>
                              <li><strong>Expert Orthopedic Surgeons:</strong>Our experienced orthopedic specialists are 
                              highly skilled in performing various joint replacement procedures, including hip,
                               knee, shoulder, and elbow replacements.</li>
                              <li><strong>State-of-the-Art Technology:</strong> We use the latest surgical techniques 
                              and high-quality prosthetics for precise joint replacements, ensuring long-lasting results.</li>
                              <li><strong>Minimally Invasive Options: </strong>Whenever possible, we offer minimally 
                              invasive surgery that reduces recovery time, minimizes scarring, and improves
                               overall outcomes.</li>
                              <li><strong>Comprehensive Care:</strong> From pre-surgery consultations and 
                              detailed assessments to post-surgery rehabilitation and recovery, we provide complete
                               care to help you heal and regain strength.</li>
                               <li><strong>Personalized Treatment Plans: </strong>We tailor each treatment to meet 
                               the specific needs of the patient, ensuring the best possible outcomes and a quicker
                                return to daily activities.</li>
                           </ul>
                           <p>At Jawahar Hospital, we are committed to helping you regain your mobility and improve 
                            your quality of life through advanced joint replacement techniques and compassionate care.</p>
