      ...
      <div class="inner_banner" style="background-image: url(assets/images/specialities_banner.png);">
         <div class="container-fluid text-center">
            <div class="inner_bantext">
               <h2>Kidney Transplant Surgeons</h2>
            </div>
            <div class="breadcrumb-menu">
               <ul>
                  <li><a href="index.php">Home</a></li>
                  <li><a href="javascript:;">Specialities</a></li>
                  <li class="active">Kidney Transplant Surgeons</li>
               </ul>
            </div>
         </div>
      </div>
            ...
            <div class="col-md-8 scleft">
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blg_img">
                           <img src="assets/images/kidney_transparent.png">
                        </div>
                        <div class="blog_details">
                           <h4>Kidney Transplant Surgeons</h4>
                           <p>At Jawahar Hospital, our Kidney Transplant Surgeons provide exceptional care for 
                            patients with end-stage kidney disease or severe renal failure. Our dedicated transplant 
                            team is committed to delivering advanced, life-saving kidney transplant services with precision, 
                            compassion, and cutting-edge technology.</p>
                           <ul>
                              <li><strong>Expert Transplant Surgeons:</strong>Our highly skilled and experienced surgeons specialize
                               in performing successful kidney transplants with minimal complications.</li>
                              <li><strong>Comprehensive Pre-Transplant Evaluation:</strong>Thorough assessments and counseling for donors and 
                              recipients to ensure compatibility and optimize outcomes.</li>
                              <li><strong>Advanced Surgical Techniques:</strong> Utilizing the latest minimally invasive and robotic-assisted
                               procedures to ensure quicker recovery and reduced risk.</li>
                              <li><strong>Post-Transplant Care:</strong>A dedicated team of nephrologists, dieticians, and 
                              physiotherapists ensures continuous care and guidance for long-term kidney health.</li>
                              <li><strong>Multidisciplinary Approach:</strong>Seamless coordination between specialists,
                               including urologists, nephrologists, anesthesiologists, and critical care experts, for comprehensive
