      ...
      <div class="inner_banner" style="background-image: url(assets/images/services_banner.png);">
         <div class="container-fluid text-center">
            <div class="inner_bantext">
               <h2>Joint Replacement Surgeries</h2>
            </div>
            <div class="breadcrumb-menu">
               <ul>
                  <li><a href="index.php">Home</a></li>
                  <li><a href="javascript:;">Services</a></li>
                  <li class="active">Joint Replacement Surgeries</li>
               </ul>
            </div>
         </div>
      </div>
               ...
               <div class="service-content">
                  <div class="hp_wrapper">
                        ...
                        <div class="blog_details">
                           <h4>Joint Replacement Surgeries</h4>
                           <p>At Jawahar Hospital, we offer advanced Joint Replacement Surgeries to restore mobility and improve 
                            quality of life for patients with severe joint pain or damage. With the latest techniques and expert 
                            care, we ensure safe, effective, and long-lasting results for a pain-free lifestyle.</p>
                           <ul>
                              <li><strong>Expert Orthopedic Surgeons: </strong>Highly skilled specialists with extensive experience in joint replacement procedures.</li>
                              <li><strong>Advanced Techniques:  </strong>Use of cutting-edge technology for precise and minimally invasive surgeries..</li>
                              <li><strong>Comprehensive Care: </strong> End-to-end support from pre-surgical consultation to post-surgical rehabilitation.</li>
                              <li><strong>Infection-Control Measures:  </strong>High-quality implants tailored to individual needs for optimal comfort and durability.</li>
                              <li><strong>Faster Recovery: </strong>Techniques designed to minimize hospital stay and promote quicker rehabilitation.</li>
                           </ul>
                           <p>At Jawahar Hospital, our goal is to help you regain mobility and lead an active, pain-free life with world-class joint replacement solutions.</p>
